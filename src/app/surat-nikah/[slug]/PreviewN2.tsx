...
export function PreviewN2({ surat, data }: PreviewN2Props) {
  ...
  const tanggalAkad = useMemo(() => formatDateIndonesian(data.tanggalAkad), [data.tanggalAkad]);
  const tanggalSurat = useMemo(() => formatDateIndonesian(data.tanggalSurat), [data.tanggalSurat]);
  const tanggalDiterima = useMemo(() => formatDateIndonesian(data.diterimaTanggal), [data.diterimaTanggal]);
  ...
  const lampiranList = useMemo(
    ...
    [data.lampiran1, data.lampiran2, data.lampiran3, data.lampiran4, data.lampiran5, data.lampiran6, data.lampiran7, data.lampiran8],
  );
      ...
      <div className="rounded-[32px] border border-slate-300 bg-white p-6 shadow-[12px_12px_36px_rgba(197,205,214,0.35)] print-wrapper">
        <div className="mx-auto max-w-[720px] border border-slate-400 px-10 py-8 font-['Times_New_Roman',serif] text-[15px] text-slate-900 print-sheet">
          ...
          <div className="mt-5 text-center leading-tight">
            <p className="text-[18px] font-semibold uppercase">Formulir Permohonan Kehendak Perkawinan</p>
            <p className="text-[16px] font-semibold uppercase">Model N2</p>
          </div>
          ...
          <div className="mt-8 text-[15px] leading-relaxed">
            ...
            <p className="mt-6 text-justify leading-relaxed">
              Dengan hormat, kami mengajukan permohonan kehendak perkawinan untuk atas nama: Calon suami{" "}
              <span className="font-semibold">{data.calonSuamiNama || "................................"}</span> dengan Calon istri{" "}
              <span className="font-semibold">{data.calonIstriNama || "................................"}</span> pada hari{" "}
              <span className="font-semibold">{data.hariAkad || "........"}</span> tanggal{" "}
              <span className="font-semibold">{tanggalAkad}</span> jam {data.waktuAkad || "........"} bertempat di {data.tempatAkad || "........................................................"}.
            </p>

            <p className="mt-4 leading-relaxed">Bersama ini kami sampaikan surat-surat yang diperlukan untuk diperiksa sebagai berikut:</p>
            <ol className="mt-3 list-decimal space-y-2 pl-6">
              {lampiranList.length > 0 ? (
                lampiranList.map((item, index) => <li key={`${item}-${index}`}>{item}</li>)
              ) : (
                <>
                  <li>..........................................................</li>
                  <li>..........................................................</li>
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-2">
              <div className="space-y-4">
                <div>
                  <p>Diterima tanggal: {tanggalDiterima !== "-" ? tanggalDiterima : "........................"}</p>
                  <div className="mt-6 text-center">
                    <p>{data.pejabatJabatan || "Kepala KUA/Penghulu/PPN Luar Negeri"}</p>
                    <div className="mt-16">
                      <p className="font-semibold uppercase tracking-wide">{data.pejabatPenerima || "........................"}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="space-y-4 text-center">
                ...
                <p>Pemohon</p>
                <div className="mt-16">
                  <p className="font-semibold uppercase tracking-wide">{data.pemohonNama || "........................"}</p>
                </div>
              </div>
            </div>
          </div>
