    ...
    <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col gap-10 print:mt-0 print:px-0">
      ...
      <div className="rounded-[32px] border border-slate-300 bg-white p-6 shadow-[12px_12px_36px_rgba(197,205,214,0.35)] print-wrapper print:border-0">
        <div className="mx-auto max-w-[720px] border border-slate-400 px-10 py-8 font-['Times_New_Roman',serif] text-[15px] text-slate-900 print-sheet print:border-0">
          ...
          <div className="relative mt-5 text-center leading-tight">
          ...
          <p className="mt-6 text-start leading-relaxed text-[15px]">
                  ...
                  <tr>
                    ...
                    <td>
                      {combineTempatTanggal(
                        data.calonSuamiTempatLahir,
                        data.calonSuamiTanggalLahir
                      )}
                    </td>
                  </tr>
                  <tr>
              ...
              <table className="mt-2 w-full text-[15px] leading-relaxed">
                <tbody className="[&>tr>td]:align-top [&>tr>td:nth-child(1)]:w-[230px] [&>tr>td:nth-child(2)]:w-4">
                  ...
                  <tr>
                    ...
                    <td>
                      {combineTempatTanggal(
                        data.calonIstriTempatLahir,
                        data.calonIstriTanggalLahir
                      )}
                    </td>
                  </tr>
                  <tr>
          ...
          <p className="mt-6 text-justify leading-relaxed text-[15px]">
            Menyatakan dengan sesungguhnya bahwa atas dasar suka rela, dengan
            kesadaran sendiri, tanpa ada paksaan siapapun juga, setuju untuk
            melangsungkan perkawinan.
          </p>

          <p className="mt-4 text-justify leading-relaxed text-[15px]">
