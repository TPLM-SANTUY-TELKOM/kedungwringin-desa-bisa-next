...
import { formatDateIndonesian, type PernyataanBelumMenikahData } from "@/app/surat-nikah/types";
...
export function PreviewPernyataanBelumMenikah({ surat, data }: PreviewPernyataanBelumMenikahProps) {
  ...
  return (
    <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col gap-10 print:mt-0 print:px-0">
      ...
      <div className="rounded-[32px] border border-slate-300 bg-white p-6 shadow-[12px_12px_36px_rgba(197,205,214,0.35)] print-wrapper">
        <div className="mx-auto max-w-[680px] border border-slate-400 px-10 py-8 font-['Times_New_Roman',serif] text-[15px] text-slate-900 print-sheet">
          <div className="text-center leading-tight">
            <p className="text-[18px] font-semibold uppercase">Surat Pernyataan Belum Menikah</p>
          </div>
          ...
          <p className="mt-6 text-justify leading-relaxed">
            Dengan ini menyatakan yang sesungguhnya dan sebenarnya, bahwa saya sampai saat ini belum pernah menikah dengan seorang perempuan, baik secara resmi maupun di bawah tangan (masih lajang).
          </p>

          {data.pernyataanTambahan && (
            <p className="mt-3 text-justify leading-relaxed">{data.pernyataanTambahan}</p>
          )}

          <p className="mt-3 text-justify leading-relaxed">
            Surat pernyataan ini saya buat untuk melengkapi persyaratan menikah. Demikian surat pernyataan ini saya buat, ditandatangani dalam keadaan sehat jasmani dan rohani, tanpa ada paksaan dan bujukan dari siapapun. Apabila surat pernyataan ini tidak benar, maka saya bersedia bertanggung jawab di hadapan hukum yang berlaku.
          </p>
          ...
          <div className="mt-16 text-center text-[15px] leading-relaxed">
