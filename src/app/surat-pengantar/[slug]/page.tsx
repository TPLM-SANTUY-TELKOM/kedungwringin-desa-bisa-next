...
import { SuratFormIzinKeramaian } from "./SuratFormIzinKeramaian";
        ...
        return (
          <Card className="mx-auto mt-16 max-w-3xl rounded-3xl border border-white/60 bg-white/70 shadow-[8px_8px_24px_rgba(180,190,205,0.35)]">
            <CardContent className="p-10 text-center">
              ...
              <Link href="/surat-pengantar" className="mt-6 inline-flex items-center justify-center rounded-full bg-slate-900 px-6 py-2 text-sm font-semibold text-white hover:bg-slate-800">
