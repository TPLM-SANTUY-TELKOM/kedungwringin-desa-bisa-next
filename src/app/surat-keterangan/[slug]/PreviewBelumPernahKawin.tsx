...
import type { SuratKeteranganBelumPernahKawinData } from "@/app/surat-keterangan/types";
          ...
          <table className="mt-2 w-full text-[14px] leading-tight">
            <tbody className="[&>tr>td]:py-0.5 [&>tr>td]:align-top">
              <tr>
                ...
                <td className="font-semibold uppercase">{data.namaPenandatangan}</td>
              </tr>
              <tr>
                <td>b.</td>
                <td>Jabatan</td>
                <td className="pr-3">:</td>
                <td className="uppercase">{data.jabatanPenandatangan}</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="mt-2 w-full text-[14px] leading-tight">
            <tbody className="[&>tr>td]:py-0.5 [&>tr>td]:align-top">
              ...
              <tr>
                ...
                <td>Desa/Kel</td>
                <td className="pr-3">:</td>
                <td className="uppercase">{data.desaKel}</td>
              </tr>
              <tr>
                <td></td>
                <td>Kecamatan</td>
              ...
              <tr>
                ...
                <td>Provinsi</td>
                <td className="pr-3">:</td>
                <td className="uppercase">{data.provinsi}</td>
              </tr>
            </tbody>
          </table>
