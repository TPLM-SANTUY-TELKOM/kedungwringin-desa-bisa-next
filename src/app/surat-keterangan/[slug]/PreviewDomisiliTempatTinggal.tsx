...
import type { SuratKeteranganDomisiliTempatTinggalData } from "@/app/surat-keterangan/types";
import logoDesa from "@/assets/ic_logo_banyumas.png";
import { getPejabatByNama } from "@/lib/pejabat";

type PreviewDomisiliTempatTinggalProps = {
  surat: SuratKeteranganOption;
  data: SuratKeteranganDomisiliTempatTinggalData;
...
export function PreviewDomisiliTempatTinggal({ surat, data, reservedNumberId }: PreviewDomisiliTempatTinggalProps) {
      ...
      <div className="rounded-4xl border border-slate-300 bg-white p-6 shadow-[12px_12px_36px_rgba(197,205,214,0.35)] print-wrapper">
        <div className="mx-auto max-w-[720px] px-10 py-8 font-['Times_New_Roman',serif] text-[15px] text-slate-900 print-sheet">
          ...
          <div className="mt-6 text-center">
            <p className="text-[16px] font-bold uppercase underline">Surat Keterangan Domisili Tempat Tinggal</p>
          ...
          <table className="mt-4 w-full text-[14px] leading-relaxed">
            <tbody className="[&>tr>td]:py-1 [&>tr>td]:align-top">
              ...
              <tr>
                ...
                <td className="pr-3">:</td>
                <td>{data.alamatAsal || "-"}, RT.{data.rt} / RW.{data.rw}, {data.kelurahan}, {data.kecamatan}, {data.kabupaten}</td>
              </tr>
              <tr>
                <td>8.</td>
                <td>Alamat Domisili</td>
                <td className="pr-3">:</td>
                <td className="font-semibold">{data.alamatDomisili}</td>
              </tr>
              <tr>
                <td>9.</td>
                <td>Keperluan</td>
          ...
          <div className="mt-6 space-y-3 text-[14px] leading-relaxed">
            <p className="text-justify">Bahwa yang bersangkutan adalah benar berdomisili di alamat tersebut di atas dan merupakan warga Desa Kedungwringin.</p>
