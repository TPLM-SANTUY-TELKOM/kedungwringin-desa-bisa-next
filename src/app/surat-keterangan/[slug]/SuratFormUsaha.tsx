          ...
          <form className="space-y-10">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input value={form.jenisUsaha} onChange={handleInputChange("jenisUsaha")} placeholder="Contoh: Perdagangan" className={INPUT_BASE} />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea value={form.keperluan} onChange={handleInputChange("keperluan")} placeholder="Contoh: Mengajukan permohonan izin usaha" className={TEXTAREA_BASE} />
              </div>
            </div>
