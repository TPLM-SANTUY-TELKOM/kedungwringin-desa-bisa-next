...
import type { SuratKeteranganTidakMampuData } from "@/app/surat-keterangan/types";
import logoDesa from "@/assets/ic_logo_banyumas.png";

type PreviewTidakMampuProps = {
  surat: SuratKeteranganOption;
  data: SuratKeteranganTidakMampuData;
};
...
export function PreviewTidakMampu({ surat, data }: PreviewTidakMampuProps) {
      ...
      <div className="rounded-4xl border border-slate-300 bg-white p-6 shadow-[12px_12px_36px_rgba(197,205,214,0.35)] print-wrapper">
        <div className="mx-auto max-w-[720px] px-10 py-8 font-['Times_New_Roman',serif] text-[15px] text-slate-900 print-sheet">
          ...
          <div className="mt-6 text-center">
            <p className="text-[16px] font-bold uppercase underline">Surat Keterangan Tidak Mampu</p>
          ...
          <div className="mt-6 space-y-3 text-[14px] leading-relaxed">
            <p className="text-justify">Berdasarkan Surat Keterangan dari Ketua Rukun Tetangga 009 Nomor Tanggal, bahwa yang bersangkutan betul warga Desa Kedungwringin dan menurut pengakuan yang bersangkutan keadaan ekonominya TIDAK MAMPU.</p>
          ...
          <div className="mt-10 flex justify-end">
            <div className="w-[280px] text-center">
              ...
              <p className="text-[14px]">KEPALA DESA KEDUNGWRINGIN</p>
